...
import {Switch, Route, Link, useRouteMatch, useHistory
...
const AnecdoteList = ({ anecdotes }) => (
  <div>
    ...
    <ul>
      ...
      <li key={anecdote.id} ><Link to={`/${anecdote.id}`}>{anecdote.content}</Link> 
      </li>)}
    </ul>
  </div>
)
...
const CreateNew = (props) => {
  ...
  const anecdoteUrl = useField('text')
